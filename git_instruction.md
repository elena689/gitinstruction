...
Если была изменена одна и та же чать файла в обеих ветках, то может возникнуть конфликт, который потребует участие пользователя. Нужно выбрать решение из предложенных вариантов:
1. Оставить входящие изменения
2. Оставить текущий вариант
...
Эта операция потенциально опасная, необходимо удостовериться, что не пропадет полезная информация.
```
